...
export const WorkflowsPage = () => {
  ...
  return (
    <>
      <PageMeta title="Workflows - Midyeci" />
      <DashboardLayout headerStartItems={<h1 className="text-foreground-950 flex items-center gap-1">Workflows</h1>}>
        {/* Midyeci Custom Build Banner */}
        <div className="mb-4 rounded-lg bg-amber-100 border border-amber-300 p-3 text-amber-800 text-sm">
          🎉 <strong>Midyeci Custom Build</strong> - Dashboard successfully built from source!
        </div>
